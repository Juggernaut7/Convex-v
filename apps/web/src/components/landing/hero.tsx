        ...
        <div className="flex-1 space-y-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-muted-foreground sm:text-xl">
              Convex lets fans back their instincts on sports, culture, and crypto with instant USDC payouts on Arc. No approvals, no gas surprises, just clean prediction markets that feel native on mobile.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              ...
              },
              {
                ...
                title: "Arc-native",
                copy: "Optimized for mobile flows with instant USDC confirmations.",
              },
            ].map((feature) => (
            ...
            <CardContent className="space-y-6 p-6 sm:p-8">
              <div className="space-y-2 text-left">
                ...
                <p className="text-sm text-muted-foreground">
                  Pool liquidity, boost odds, and earn fees every time your community’s market settles. Built on top of Arc&apos;s ultra-low gas.
                </p>
              </div>
              ...
              <div className="space-y-3 text-left">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>• Arc Mainnet (chain 5042)</li>
                  <li>• USDC settlement rails</li>
                  <li>• Native USDC wallet flow</li>
                </ul>
              </div>
