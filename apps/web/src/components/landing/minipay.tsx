...
const integrationHighlights = [
  {
    title: "Arc-native wallet UX",
    points: [
      "Connects to Arc Mainnet automatically",
      "Preconfigured Arc Mainnet RPC",
      "Native USDC staking with no approvals",
    ],
    icon: Wallet,
  },
  {
...
export function WalletExperienceSection() {
  return (
        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs font-medium text-primary">
              ...
              Arc wallet experience layer
            </div>
            <h2 className="text-3xl font-semibold sm:text-4xl">Why Convex feels native on Arc</h2>
            <p className="text-base text-muted-foreground sm:text-lg">
              Every interaction—from browsing liquidity to claiming payouts—runs with native USDC on Arc. No approval detours or browser modal maze, just conviction trading that stays in one wallet flow.
            </p>
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-sm overflow-hidden rounded-2xl border border-primary/20 bg-primary/5 shadow-xl">
              ...
              <div className="relative px-6 pb-8 pt-10">
                <p className="text-xs font-semibold uppercase tracking-wide text-primary">Wallet Preview</p>
                <h3 className="mt-3 text-lg font-semibold text-foreground">Stake confirmation</h3>
                <p className="mt-2 text-sm text-muted-foreground">
                  The wallet flow displays Convex&apos;s stake experience with native styling, keeping users in a trusted frame.
                </p>
