...
const steps = [
  ...
  {
    title: "Stake with native USDC",
    description: "Tap the side you believe in, confirm in your wallet, and your stake is live in seconds.",
    icon: Timer,
  },
  {
  ...
  },
  {
    ...
    description: "Winning stakes settle straight to your wallet—no additional steps needed.",
    icon: Lock,
  },
];
    ...
    <section className="bg-foreground/5 py-20">
      <div className="container mx-auto max-w-6xl px-4">
        <div className="mb-12 text-center">
          <h2 className="text-3xl font-semibold sm:text-4xl">How Convex flows on Arc</h2>
