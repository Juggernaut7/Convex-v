      ...
      <div className="container mx-auto max-w-5xl px-4">
        <div className="space-y-6 text-center">
          ...
          <h2 className="text-3xl font-semibold sm:text-4xl">
            Ship your Arc-native conviction market with Convex in under two weeks.
          </h2>
          <p className="mx-auto max-w-2xl text-base text-primary-foreground/80 sm:text-lg">
            Fork the repo, deploy to Arc Mainnet, and showcase a polished native-USDC prediction experience. Convex handles wallet detection, stake flows, and payout scaffolding so you can focus on product polish.
          </p>
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button asChild size="lg" className="rounded-full bg-primary-foreground text-primary hover:bg-primary-foreground/90 hover:text-primary">
              <Link href="https://github.com/abdulkabir7/Convex-v1" target="_blank">
                View GitHub repo
              </Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="rounded-full border-white/70 bg-transparent text-primary-foreground hover:bg-primary-foreground hover:text-primary">
              <Link href="https://docs.arc.network" target="_blank">
                Explore Arc docs <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            </Button>
          </div>
        </div>
