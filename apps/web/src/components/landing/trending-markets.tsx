          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div className="space-y-2">
              ...
              <p className="text-base text-muted-foreground sm:max-w-xl">
                Tap into community-powered liquidity. Tap a side, sign in your wallet, and you&apos;re live on-chain—no approval transaction required.
              </p>
            </div>
        ...
        <div className="mt-12 flex flex-col gap-3 rounded-2xl border border-dashed border-primary/30 bg-primary/5 px-6 py-8 text-center sm:flex-row sm:items-center sm:justify-between sm:text-left">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Stake 50 USDC to launch a verified market and earn 1% fees on every settlement.</p>
            </div>
          </div>
