...
const FEATURES = [
  ...
  {
    title: "Wallet native",
    description: "Works with Arc Mainnet and every compatible EVM wallet out of the box.",
  },
  {
...
const WHY_CONVEX = [
  ...
  "Built on Arc for instant, low-fee payouts.",
] as const;
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-2xl space-y-6">
            <h1 className="text-balance text-3xl font-semibold leading-tight text-[#0F172A] sm:text-[44px] sm:leading-[1.1]">
              Trade your conviction. Predict and win USDC.
            </h1>
