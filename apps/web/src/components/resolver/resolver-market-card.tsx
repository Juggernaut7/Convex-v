          ...
          <div className="rounded-xl border border-[#E5E7EB] bg-white p-3">
            ...
            <div className="mt-2 space-y-1">
              <div className="flex items-center justify-between">
                <span>Yes</span>
                <span className="font-semibold text-[#217756]">{formatNumber(market.yesPool, 2)} USDC</span>
              </div>
              <div className="flex items-center justify-between">
                <span>No</span>
                <span className="font-semibold text-[#B91C1C]">{formatNumber(market.noPool, 2)} USDC</span>
              </div>
            </div>
          </div>
