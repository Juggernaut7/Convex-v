...
export function MarketGallery({
  ...
  return (
    <>
      <div className="sticky top-16 z-30 bg-[#0a0d14]/90 pb-4 pt-1 backdrop-blur-lg">
        <MarketFilterBar
        ...
        <section className="mb-6 space-y-3">
          ...
          <div className="-mx-1 flex gap-4 overflow-x-auto pb-2">
            {trendingMarkets.map((market) => (
              <div
                key={market.id}
                className="min-w-[240px] max-w-[260px] flex-none rounded-2xl border border-zinc-800 bg-secondary/30 p-1 shadow-sm backdrop-blur-sm transition hover:-translate-y-1 hover:shadow-lg"
              >
      ...
      <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
        {filteredMarkets.length === 0 ? (
          <div className="col-span-full rounded-2xl border border-dashed border-zinc-800 bg-secondary/30 p-10 text-center text-sm text-muted-foreground">
